...
// const editedProduct=function ({id,title,description}){
//   const editedList = allProducts.map((product)=>{
//     if(id===product.id){
...
//   images: ['https://i.dummyjson.com/data/products/3/1.jpg'],
// }
// console.log(editedProduct(guncel));

// const findProduct=function(keyword){
//   const filteredWords = allProducts.filter((product)=>{
//    return product.title.toLowerCase().includes(keyword.toLowerCase())||product.description.toLowerCase().includes(keyword.toLowerCase())||product.brand.toLowerCase().includes(keyword.toLowerCase())})
...
// // Fiyatı 20'den büyük olan ürünleri yeni bir diziye sakla
// const yuksekFiyatliUrunler = urunler.filter(urun => urun.fiyat > 20);
